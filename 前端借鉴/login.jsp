...
<div class="container"  style="width:100%;height:460px;background:#FF2C4C url('img/fff.jpg') repeat-x;">
<div class="row"> 
	<div class="col-md-7">
	...
	<div class="col-md-5">
				<div style="width:440px;border:1px solid #E7E7E7;padding:20px 0 20px 30px;border-radius:5px;margin-top:60px;background:Ivory ;">
				<font>会员登录</font><img alt="" src="img/timg.jpg" width="30px" height="30px" >
...
<form class="form-horizontal" action="LoginServlet" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" name="uname" class="form-control" id="username" placeholder="请输入用户名">
    </div>
  </div>
   <div class="form-group">
